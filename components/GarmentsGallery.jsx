...
export default function GarmentsGallery({ gallery }) {
  console.log(gallery);
          ...
          <Col lg={12}>
            <div className="gallery-title">
              <Title
                ...
                color={"#333333"}
                fontSize={"60"}
                text={gallery?.section_data?.subtitle}
              />
              <p className="subtitle">{gallery?.section_data?.short_desc}</p>
            </div>
          </Col>
