...
const Footer = () => {
  ...
  return (
    <FooterWrapper>
      ...
      <MessengerButton href="https://m.me/luminoushousing" aria-label="Chat on Messenger">
        <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" width="36" height="36">
          <path d="M18 0C8.059 0 0 7.254 0 16.873C0 21.429 1.985 25.476 5.2 28.399V36L12.571 32.863C14.287 33.379 16.11 33.746 18 33.746C27.941 33.746 36 26.492 36 16.873C36 7.254 27.941 0 18 0Z" fill="#0084FF"/>
          <path d="M19.991 22.7L14.822 17.158L5 22.7L15.755 11.2L21.168 16.743L30.747 11.2L19.991 22.7Z" fill="white"/>
        </svg>
      </MessengerButton>
    </FooterWrapper>
  );
